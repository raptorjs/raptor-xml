...
var SAXParserFactory = Packages.javax.xml.parsers.SAXParserFactory;
var DefaultHandler = Packages.org.xml.sax.helpers.DefaultHandler;
var JavaString = Packages.java.lang.String;
var factory = SAXParserFactory.newInstance();
var raptorUtil = require('raptor-util');
var BaseSaxParser = require('./BaseSaxParser');
...
function Element(uri, localName, qName, javaAttributes, prefixMappings) {
    this.uri = uri;
    this.localName = localName;
    this.qName = qName;
    ...
    getAttributes: function() {
        ...
        if (!attributes) {
            ...
            for (var i=0, len=javaAttributes.getLength(); i<len; i++) {
                var localName = javaAttributes.getLocalName(i),
                    qName = javaAttributes.getQName(i),
                    uri = javaAttributes.getURI(i),
                    value = javaAttributes.getValue(i);
...
var SaxParser = function(options) {
    SaxParser.$super.call(this, options);
};
